...
<title>HK${query} - Search</title>
<meta name="Keywords" content="java,Tao Tao java" />
<meta name="description" content="Find a similar product 29910 Java in Edinburgh, which contains a "book", "E-book", "audio visual education", "ride" and other types of Java products." />
...
<!-- header end -->
<div class="w main">
	<div class="crumb">All results&nbsp;&gt;&nbsp;<strong>"${query}"</strong></div>
<div class="clr"></div>
<div class="m clearfix" id="bottom_pager">
<div  id="pagin-btm" class="pagin fr" clstag="search|keycount|search|pre-page2">
	<span class="prev-disabled">Previous page<b></b></span>
	...
	<a href="search?keyword=java&enc=utf-8&qr=&qrst=UNEXPAND&rt=1&page=2" class="next">next page<b></b></a>
	<span class="page-skip"><em>&nbsp;&nbsp;contains${totalPages}pages&nbsp;&nbsp;&nbsp;&nbsp;page</em></span>
</div>
</div>
...
<li class="item-book" bookid="11078102">
	...
	<div class="p-price">
		<i>Price：</i>
		<strong>HK$<fmt:formatNumber groupingUsed="false" maxFractionDigits="2" minFractionDigits="2" value="${item.price }"/></strong>
	</div>
	<div class="service">Shipped by Emind</div>
	<div class="extra">
