            ...
            <div class="mod-main">
						<div class="mt">
							<ul class="extra-l">
                                ...
                                <li class="fore-2"><a class="curr" href="http://i.jd.com/user/userinfo/showImg.html">Avatar</a></li>
						...
						<div class="mc update-face-cont">
							<div class="update-lcol">
								<div class="mb10">
									...
									<div class="ftx03">Size not exceeding 4M is recommended,and format should be JPG、GIF、PNG、JPEG、BMP.</div>
								</div>
								...
								<div class="smt"><h3>Recommended Avatar</h3></div>
								<div class="smc face-list">
									...
									<div class="btns mt20">
									   <a href="javascript:void(0)" class="btn-5 mr10" onclick="uploadDefaultImg()">Save</a>
									</div>
								</div>
							</div>
							<div class="update-rcol">
								<div class="smt"><h3>Preview</h3></div>
								<div class="smc">
									Photos you upload will be automatically generated in two sizes，Please note that the small size of the picture is clear
