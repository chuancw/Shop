...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value=" ruyunlong"/>
		<input type="hidden" name="orderShipping.receiverMobile" value="15891588888"/>
		<input type="hidden" name="orderShipping.receiverState" value="beijing"/>
		<input type="hidden" name="orderShipping.receiverCity" value="beijing"/>
		<input type="hidden" name="orderShipping.receiverDistrict" value="changpingqu"/>
		<input type="hidden" name="orderShipping.receiverAddress" value="xisanqi xxxxxxxxx"/>
</form>
...
<div class="step-tit">
	...
	<div class="extra-r">
		<a href="#none" class="ftx-05" onclick="use_NewConsignee()">Add a new address</a>
	</div>
</div>
<div class="step-cont">
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							<div class="fl">
								<strong limit="4">${username}</strong>&nbsp;&nbsp;Receive
							</div>
							&nbsp;&nbsp;Tel:<div class="fr">${phone}</div>
							<div class="clr"></div>
						</div>
						 Address:    
						    <form action="/order/save" method="post">
					          <textarea  name="address" rows="4" cols="30" >${address1}</textarea>
			...
			<ul id="payment-list">
				...
				<li style="cursor: pointer;" onclick="save_Pay(4);">
					...
					<div class="payment-item  online-payment "
						...
						<b></b>  pay online <font class="whiteBarSpanClass hide"
							color="#FF6600">[support taotao loans]</font> <span
...
<div class="step-tit">
	<h3>Manifest</h3>
	<div class="extra-r">
					<a href="/cart/show.html" id="cartRetureUrl" class="return-edit ftx-05">return to modify the shopping cart</a>
			</div>
</div>
...
<div class="shopping-list ABTest">
	<div class="goods-list">
     <!--配送方式-->
    <h4 class="vendor_name_h" id="0">shop owner:taotao</h4>		         
		...
		<div class="goods-item goods-item-extra">
			...
			<div class="goods-msg">
				...
				<div class="p-price">
					...
					<span class="ml20 p-inventory" skuId="11555193">available</span>
				</div>
				<i class="p-icon p-icon-w"></i><span class="ftx-04">7 days no reason to return</span>
			</div>
			<div class="clr"></div>
		</div>
	</c:forEach>
...
<div class="dis-modes">
	...
	<div class="mode-item mode-tab">
		<h4>
			shipping mode：（<a id="jd-goods-item" class="ftx-05 alink"
...
<div class="freight-cont">
	<strong class="ftx-01" style="color: #666"
			freightByVenderId="0" popJdShipment="false">free shipping</strong>
</div>
</div>	
...
<div class="step-content">
	<div id="part-inv" class="invoice-cont">
		<span class="mr10"> nomal invoice(e-invoice) &nbsp; </span><span class="mr10">
			个人 &nbsp; </span><span class="mr10"> &nbsp; </span> detail <a href="#none"
			class="ftx-05 invoice-edit" onclick="edit_Invoice()">modify</a>
	</div>
</div>
		<div class="order-summary">
			...
			<div class="statistic fr">
				...
				<div class="list">
					<span>freight：</span> <em class="price" id="freightPriceId">
						￥0.00</em>
				</div>
				<div class="list">
					<span>actual payment：</span> <em class="price" id="sumPayPriceId">
      ...
      <div class="sticky-wrap">
          ...
          <button type="submit" class="checkout-submit btn-1" 
          	...
          	Submit the order
                    ...
                    <span class="total">actual payment：<strong id="payPriceId">￥<fmt:formatNumber value="${totalPrice}" maxFractionDigits="2" minFractionDigits="2" groupingUsed="true"/></strong>
          </span>
                    <span id="checkCodeDiv"></span>
          <div class="checkout-submit-tip" id="changeAreaAndPrice" style="display: none;">
            Please check and then submit the order.
          </div>
          <div style="display:none" id="factoryShipCodShowDivBottom" class="dispatching">
            Part of goods can be cashed on delivery: they will be delivered by  taotao deliver and recive payment,then the shop will  send out the goods .
。
          </div>
        </div>
