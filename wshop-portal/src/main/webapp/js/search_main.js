...
SEARCH.bottom_page_html = function(e, k, j) {
    ...
    if (e <= 1) {
        f += '<span class="prev-disabled">Previous<b></b></span>'
    } else {
    ...
    if (e >= k) {
        f += '<span class="next-disabled">Next<b></b></span>'
    } else {
        f += '<a onclick="SEARCH.page(' + g + ', true)" href="javascript:;" class="next" title="使用方向键右键也可翻到下一页哦！">下一页<b></b></a>'
    }
    f += '<span class="page-skip"><em>&nbsp;&nbsp;Total of&nbsp;' + k + '&nbsp;page&nbsp;&nbsp;&nbsp;&nbsp;Go</em><input class="jumpto" type="text" value="' + e + '" onkeydown="javascript:if(event.keyCode==13){SEARCH.page_jump(' + k + "," + j + ');return false;}"/><em>page</em><a class="btn-skipsearch" value="确定" onclick="SEARCH.page_jump(' + k + "," + j + ')" href="javascript:;">Confirm</a></span>';
    $("#pagin-btm").html(f)
};
