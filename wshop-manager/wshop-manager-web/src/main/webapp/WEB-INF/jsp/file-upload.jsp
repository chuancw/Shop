...
<div class="container">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">Explain</h3>
        </div>
        <div class="panel-body">
            <ul>
                <li>Upload file size limit：<strong>5 MB</strong>.</li>
                <li>Supported file formats：<strong>JPG, GIF, PNG, BMP </strong>.</li>
            </ul>
        </div>
    </div>
</div>
