 ...
 * Generated at: 2016-12-27 07:04:22 UTC
...
public final class content_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t            <th data-options=\"field:'title',width:120\">Title</th>\r\n");
      out.write("\t\t            <th data-options=\"field:'subTitle',width:100\">Subtitle</th>\r\n");
      out.write("\t\t            <th data-options=\"field:'titleDesc',width:120\">Description</th>\r\n");
      out.write("\t\t            <th data-options=\"field:'url',width:60,align:'center',formatter:TAOTAO.formatUrl\">URL</th>\r\n");
      out.write("\t\t            <th data-options=\"field:'pic',width:50,align:'center',formatter:TAOTAO.formatUrl\">Picture</th>\r\n");
      out.write("\t\t            <th data-options=\"field:'pic2',width:50,align:'center',formatter:TAOTAO.formatUrl\">Picture 2</th>\r\n");
      out.write("\t\t            <th data-options=\"field:'created',width:130,align:'center',formatter:TAOTAO.formatDateTime\">Creation date</th>\r\n");
      out.write("\t\t            <th data-options=\"field:'updated',width:130,align:'center',formatter:TAOTAO.formatDateTime\">Updated date</th>\r\n");
      out.write("\t\t        </tr>\r\n");
      out.write("\t\t    </thead>\r\n");
      out.write("\t\t</table>\r\n");
      out.write("        </div>\r\n");
      ...
      out.write("    text:'newly increased',\r\n");
      ...
      out.write("    \t\t$.messager.alert('Notice','You must select a content classification of new content');\r\n");
      out.write("    \t\treturn ;\r\n");
      out.write("    \t}\r\n");
      ...
      out.write("    \t\t$.messager.alert('Notice','You must select a content to edit!');\r\n");
      out.write("    \t\treturn ;\r\n");
      out.write("    \t}\r\n");
      out.write("    \tif(ids.indexOf(',') > 0){\r\n");
      out.write("    \t\t$.messager.alert('Notice','Can only choose one!');\r\n");
      out.write("    \t\treturn ;\r\n");
      out.write("    \t}\r\n");
      out.write("\t\tTT.createWindow({\r\n");
      ...
      out.write("    \tvar ids = TT.getSelectionsIds(\"#contentList\");\r\n");
      out.write("    \tif(ids.length == 0){\r\n");
      out.write("    \t\t$.messager.alert('Notice','Uncheck items!');\r\n");
      out.write("    \t\treturn ;\r\n");
      out.write("    \t}\r\n");
      out.write("    \t$.messager.confirm('Confirm','Do you confirm to delete the content whose id is'+ids+' ？',function(r){\r\n");
      out.write("    \t    if (r){\r\n");
      out.write("    \t    \tvar params = {\"ids\":ids};\r\n");
      out.write("            \t$.post(\"/content/delete\",params, function(data){\r\n");
      out.write("        \t\t\tif(data.status == 200){\r\n");
      out.write("        \t\t\t\t$.messager.alert('prompting','Content was removed successfully!',undefined,function(){\r\n");
