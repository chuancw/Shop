...
<div class="w">
    <div id="logo">
    	<a href="http://localhost:8082" clstag="passport|keycount|login|01">
    		<img src="/images/taotao-logo.gif" alt="TaoTao" width="170" height="60"/>
    	</a>
   	</div>
</div>
    ...
    <div class=" w1" id="entry">
        <div class="mc " id="bgDiv">
            ...
            <div class="form ">
                ...
                <div id="capslock"><i></i><s></s>Keyboard Caps Lock is turned on,please pay attention to capitalization</div>
                ...
                <div class="item login-btn2013">
                    ...
                    <input type="button"  id="loginsubmit" value="Login" tabindex="8" clstag="passport|keycount|login|06"/>
                </div>
            </div>
        </div>
        <div class="free-regist">
            <span><a href="/page/register" clstag="passport|keycount|login|08">Register&gt;&gt;</a></span>
        </div>
    </div>
</form>
<script type="text/javascript">
			...
			doLogin:function() {
				$.post("/user/login", $("#formlogin").serialize(),function(data){
					if (data.status == 200) {
						...
						alert("Login failed.the problem is:" + data.msg);
						$("#loginname").select();
					}
				});
			},
