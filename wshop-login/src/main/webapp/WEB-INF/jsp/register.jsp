...
<div class="w" id="regist">
    <div class="mt">
        <ul class="tab">
            <li class="curr">Mall Customer</li>
        </ul>
        <div class="extra">
        ...
        <form id="personRegForm" method="post" onsubmit="return false;">
            <div class="form" onselectstart="return false;">
                <div class="item" id="select-regName">
                    <span class="label"><b class="ftx04">*</b>Username：</span>
                ...
                <div id="o-password">
                    ...
                    <div class="item">
                        <span class="label"><b class="ftx04">*</b>Affirm Password：</span>
					...
					<div class="item" id="dphone">
						<span class="label"><b class="ftx04">*</b>Verify Your Phone：</span>
					...
					<div class="item">
						...
						<div class="fl item-ifo">
							<input type="text" id="email"  name="email"
								...
								<i class="i-phone"></i> <label
								id="phone_succeed" class="blank"></label>
						</div>
					</div>
                ...
                <div class="item item-new">
                    ...
                    <div class="fl item-ifo">
                        ...
                        <label for="protocol">I agree<a href="#" class="blue" id="protocol">《Mall Protocol》</a></label>
                        <span class="clr"></span>
                        <label id="protocol_error" class="error hide">Accept</label>
                    </div>
                </div>
                <div class="item">
                    <span class="label">&nbsp;</span>
                    <input type="button" class="btn-img btn-regist" id="registsubmit" value="Register" tabindex="8"
                           clstag="regist|keycount|personalreg|07"
                           onclick="REGISTER.reg();"/>
                </div>
            </div>
            <div class="phone">
                <img width="180" height="180" src="/images/1.jpg">
               <br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Alipay Login
            </div>
            <span class="clr"></span>
        </form>
...
<script type="text/javascript">
	var REGISTER={
		...
		inputcheck:function(){
				//不能为空检查
				if ($("#regName").val() == "") {
					alert("The Username can not null");
					$("#regName").focus();
					return false;
				}
				if ($("#pwd").val() == "") {
					alert("The Password can not null");
					$("#pwd").focus();
					return false;
				}
				if ($("#phone").val() == "") {
					alert("The phone number can not null");
					$("#phone").focus();
					return false;
				}
					//
	            			...
	            			$.ajax({
				            	...
				            	success : function(data) {
				            		if (data.data) {
				            			...
				            			alert("The phone number is exited！");
				            			$("#phone").select();
				            		}
				            	}
	            			});
	            		} else {
	            			alert("The Username is exited,please select another one!");
	            			$("#regName").select();
	            		}	
	            	}
				});
